...
const Registr = () => {
 ...
 const register_API  = 'https://shark.brim.uz/api/auth/register/register';
  ...
  return (
    ...
    <div className="    bg-[#0F1F2C80]   grid place-items-center  fixed h-screen   top-0 left-0 right-0 bottom-0  z-50  mx-auto items-center"
      >
         ...
         <motion.div
          ...
          transition={{ duration: 0.5 }} // Animatsiya davomiyligi
            >
          <div className=" relative   mx-auto   sm:py-0 h-auto    bg-white md:w-[400px] w-[90%] rounded-3xl shadow  dark:bg-gray-700">
            <div className="flex justify-end p-2">
              ...
              >
                ...
                <div>
                  <p className='text-red-500 italic'>{xatolik}</p>
                </div>
                <button 
                type='button'
                onClick={()=>handelSubmit()}
                  className="w-full btn text-white gap-x-4   bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 title_16_400_white leading-5 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Ro'yxatdan o'tish
                </button>
                <Link 
                  ...
                  className="w-full btnNOTGREEN gap-x-4 items-center outline-none border-0 flex flex-nowrap justify-center hover:bg-[#F2F8FB;] focus:ring-4  title_16_400 leading-5 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  {svg_login} Tizimga kirish
                </Link>
              </form>
